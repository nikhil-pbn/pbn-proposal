...
export default defineConfig({
  ...
  datasource: {
    ...
    // No shadowDatabaseUrl: on managed Postgres, `migrate dev` creates and drops
    // its own shadow database. Only the local WASM `prisma dev` server needed one
    // named explicitly, and pointing this at a dead host breaks migrations.
  },
});
